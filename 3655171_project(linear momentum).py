...
troll_A = box(pos=vector(-1,0,0), length=L, height=H, width=W, color=color.blue, make_trail=True)#animation of trolley A, its position is 1 unit away from trolley B before COLLISION
